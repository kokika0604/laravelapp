...
<table class="basic" >
 ...
 <td>
   <img src="{{$pic_url}}" height=150px width=150px/> 
   {{-- {{public_path('\local\photo.jpeg')}} --}}
   {{-- file:///{{public_path('\local\photo.jpeg')}}--}}
 </td>
</table>
</div>
...
<button style="float:right" onclick="window.open('{{route('snappy_pdf')}}')">出力</button>
<br><br>
</body>
</html>
